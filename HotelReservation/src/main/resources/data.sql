...
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'M1'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Meyer'), '2020-02-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'M2'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Jackson'), '2020-03-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'M3'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Wheeler'), '2020-04-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'O1'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Cox'), '2020-05-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'O2'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Fox'), '2020-06-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'O3'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Larson'), '2020-07-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'W1'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Nguyen'), '2020-08-01');
INSERT INTO RESERVATION (ROOM_ID, GUEST_ID, RES_DATE) VALUES ((SELECT ROOM_ID FROM ROOM WHERE ROOM_NUMBER = 'W7'), (SELECT GUEST_ID FROM GUEST WHERE LAST_NAME = 'Berry'), '2020-09-01');
